    ...
    return (report2.successcount?(
        <>  
            ...
            <table>
                ...
                <tbody>              
                    <tr><td>{report2.successcount}</td><td>{report2.failcount}</td><td>{report2.inputmemberDto.mname}</td><td>{ report2.checkmemberDto.mname}</td><td>{report2.cdate.split("T")[0]}</td>
